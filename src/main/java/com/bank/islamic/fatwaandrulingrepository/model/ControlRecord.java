package com.bank.islamic.fatwaandrulingrepository.model;
...
/**
 * The BIAN control record for this service domain: "Shariah Ruling Directory Entry".
 *
 * In BIAN, every Service Domain manages exactly one control record type whose
 * shape follows the domain's functional pattern (Catalog) applied
 * to its asset type (Shariah Ruling). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Shariah Ruling Directory Entry";
