...
class ApplicationTests {
    ...
    void serviceDomainMetadataIsServed() {
        ...
        assertThat(meta).containsEntry("serviceDomain", "Fatwa And Ruling Repository");
        assertThat(meta).containsEntry("functionalPattern", "Catalog");
    }

    @Test
    void controlRecordLifecycleWorks() {
        var created = rest.postForEntity(
                "http://localhost:" + port + "/v1/shariah-ruling-directory-entry/initiate",
