package com.bank.islamic.fatwaandrulingrepository.contract;
...
class ApiContractTest {
    ...
    void eventContractParsesAndHasRequiredShape() throws Exception {
        ...
        assertThat(String.valueOf(events.get("service"))).startsWith("isb-");
        for (Object t : (List<Object>) events.get("publishes")) {
            ...
            assertThat(String.valueOf(topic.get("topic"))).startsWith("isb.");
        }
    }
}
